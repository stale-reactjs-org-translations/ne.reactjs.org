...
यस सेक्सनमा हामी कसरी `Clock` कम्पोनेंटलाई पुन: प्रयोज्य र encapsulated बनाउन सिक्ने छौं। यसले आफ्नै टाइमर सेटअप गर्नेछ र प्रत्येक सेकेन्डमा अपडेट हुनेछ।
...
हामी पछि टाइमर कोड कम्पोनेंटमा फिर्ता थप्नेछौं।
...
यसले कम्पोनेंटको लोकल stateमा अपडेटहरू अनुसूची गर्न `this.setState()` प्रयोग गर्दछ:
...
१) जब `<Clock />` लाई `ReactDOM.render()` मा पठाइन्छ, React ले `Clock` कम्पोनेंटको कन्स्ट्रक्टरलाई कल गर्दछ। किनकि `<Clock />`मा वर्तमान समय प्रदर्शन गर्न आवश्यक छ, यसले `this.state` वर्तमान समय सहितको objectको साथमा आरम्भ गर्छ। हामी पछि यो state अपडेट गर्नेछौं।

२) React तब `Clock` कम्पोनेंटको `render()` मेथड कल गर्दछ। Reactले स्क्रिनमा प्रदर्शन हुने कुरा यसरी सिक्छ। `Clock`को रेन्डर आउटपुटसँग मेल गर्न Reactले तब DOM अपडेट गर्दछ।
